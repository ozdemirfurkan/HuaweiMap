...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private static Double lat = 41.0;
    private static Double lon = 29.2;
    private final LatLng huawei = new LatLng(41.028880,29.117224);
    ...
    public void onMapReady(HuaweiMap huaweiMap) {
        ...
        hMap.moveCamera(CameraUpdateFactory.newLatLngZoom(huawei, 13));
        addDestinationMarker(huawei);
    }
    ...
    public void getWalkingRouteResult(View view) {
        ...
        NetworkRequestManager.getWalkingRoutePlanningResult(new LatLng(lat,lon), huawei,
    ...
    public void getBicyclingRouteResult(View view) {
        ...
        removePolylines();
        removeLocationUpdatesWithCallback();
        NetworkRequestManager.getBicyclingRoutePlanningResult(new LatLng(lat,lon), huawei,
                new NetworkRequestManager.OnNetworkListener() {
                    @Override
                    public void requestSuccess(String result) {
                        generateRoute(result);
    ...
    public void getDrivingRouteResult(View view) {
        ...
        removePolylines();
        removeLocationUpdatesWithCallback();
        NetworkRequestManager.getDrivingRoutePlanningResult(new LatLng(lat,lon), huawei,
                new NetworkRequestManager.OnNetworkListener() {
                    @Override
                    public void requestSuccess(String result) {
                        generateRoute(result);
    ...
    private void renderRoute(List<List<LatLng>> paths, LatLngBounds latLngBounds) {
        ...
        if (null != latLngBounds) {
            ...
            hMap.moveCamera(CameraUpdateFactory.newLatLngZoom(paths.get(0).get(0), 15));
        }
    ...
    private void addOriginMarker(LatLng latLng) {
        ...
        mMarkerOrigin = hMap.addMarker(new MarkerOptions().position(latLng).title("Starting Point"));
    }
    ...
    private void addDestinationMarker(LatLng latLng) {
        ...
        mMarkerDestination = hMap.addMarker(new MarkerOptions().position(latLng).title("Huawei Turkey Office"));
    }
